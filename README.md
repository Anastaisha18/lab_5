...
### Текст задачи 
 В класс Дробь, добавить интерфейс на два метода: получение вещественного значения,  
...
-Для каждой из n строк: разделить по пробелам; извлечь жирность и цену; обновить минимум и  
счетчик для соответствующей жирности  
...
### Текст задачи
Определить, есть ли в очереди L хотя бы один элемент, который равен следующему за ним  
